...
import '../controllers/approved_courses_controller.dart';
...
class _ApprovedScreenState extends State<ApprovedScreen> {
  ...
  Future<void> _fetchMaterias() async {
    ...
    final result = await ApprovedCoursesController.getMateriasAprobadas();
                  ...
                  children: [
                    ...
                    Expanded(
                      child: _materias.isEmpty
                          ? const Center(
                              child: Text('No hay materias aprobadas.'))
                          : ListView.builder(
